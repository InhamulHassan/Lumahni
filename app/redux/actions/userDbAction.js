...
export const userLogin = data => {
  return async dispatch => {
    try {
      ...
      if (result.success) {
        // store user details and jwt token in AsyncStorage to keep user logged in between page refreshes
        await AsyncStorage.setItem("auth_token", JSON.stringify(result.authToken));
